...
end MULT_S35xS35_PDm;

architecture rtl of MULT_S35xS35_PDm is
  ...
  signal s12   : std_logic_vector(69 downto 0);
  signal s34   : std_logic_vector(69 downto 0);
  signal sum70 : std_logic_vector(69 downto 0);
  signal A35   : std_logic_vector(34 downto 0);
  signal B35   : std_logic_vector(34 downto 0);
  
  signal s1, s2, s3, s4 : std_logic_vector(69 downto 0);
...
begin
  ...
  U11 : MULT_S18xS18_PDm
    ...
    s1 <= pad(P00, 70, 0);
    s2 <= pad(P10, 53, 1) & "00000000000000000";
    s3 <= pad(P01, 53, 1) & "00000000000000000";
